  ...
  _createClass(LayerGl, [{
    ...
    value: function setup(canvas) {
      ...
      gl.disable(gl.DEPTH_TEST);
			const cities = [{"id":"Algiers", "latitude": 36.70000, "longitude": 3.21700} ,{"id": "Khartoum", "latitude": 15.56670, "longitude": 32.60000 },{"id": "New York", "latitude": 40.75170, "longitude": -73.99420}, {"id": "London", "latitude": 51.50722, "longitude": -0.12750}, {"id": "Bogota", "latitude": 4.63330, "longitude": -74.09990}, {"id": "Paris", "latitude": 48.85000, "longitude": 2.33330}]
      ...
      // look up the locations for the inputs to our shaders.
			// var u_matLoc = gl.getUniformLocation(program, 'worldCoord');
    ...
    value: function onDrawLayer(info) {
      ...
      preparedData.forEach(function (obj, i) {
        ...
        gl.drawArrays(gl.LINE_LOOP, 0, obj.linesArray.length / 2);
			...
			// // attach matrix value to 'mapMatrix' uniform in shader
      // const matrixLoc = gl.getUniformLocation(program, "mapMatrix");
      // gl.uniformMatrix4fv(matrixLoc, false, mapMatrix);
      // //
      // // On SCREEN
      // // Bind Shader attributes
      // gl.bindBuffer(gl.ARRAY_BUFFER, pointArrayBuffer);           // Bind world coord
      // const attributeLoc = gl.getAttribLocation(program, "u_matrix");
      // gl.enableVertexAttribArray(attributeLoc);
      // gl.vertexAttribPointer(attributeLoc, 2, gl.FLOAT, false, 0, 0);
      //
      // gl.bindBuffer(gl.ARRAY_BUFFER, sizeArrayBuffer);            // Bind point size
      // const attributeSize = gl.getAttribLocation(program, "aPointSize");
      ...
      // gl.bindFramebuffer(gl.FRAMEBUFFER, null);
       ...
       // gl.bindFramebuffer(gl.FRAMEBUFFER, framebuffer);
       // gl.bindBuffer(gl.ARRAY_BUFFER, pointArrayBuffer);           // Bind world coord
       // let attributeLoc = gl.getAttribLocation(program, "u_matLoc");
       //
    ...
    //    // Bind Shader attributes
    //    gl.bindBuffer(gl.ARRAY_BUFFER, pointArrayBuffer);           // Bind world coord
    //    attributeLoc = gl.getAttribLocation(program, "u_matLoc");
    //    gl.enableVertexAttribArray(1);
    //    gl.vertexAttribPointer(1, 2, gl.FLOAT, false, 0, 0);
    //
    //    gl.bindBuffer(gl.ARRAY_BUFFER, sizeArrayBuffer);            // Bind point size
    ...
    //    gl.enableVertexAttribArray(attributeSize);
    //    gl.vertexAttribPointer(attributeSize, 1, gl.FLOAT, false, 0, 0);
		// 	 console.log(colorArrayBuffer, 'cccc')
    //    gl.bindBuffer(gl.ARRAY_BUFFER, colorArrayBuffer);   // Bind point color
